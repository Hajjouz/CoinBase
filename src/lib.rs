...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting CoinBase processing");
    
    let mut processor = CoinBaseProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = CoinBaseProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = CoinBaseProcessor::new(false);
